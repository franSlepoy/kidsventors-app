      ...
      >
        ...
        <div className="profile-top">
          ...
          <div className="profile-name-block">
            ...
            {age && <p className="profile-age">🎂 {age} años {student.birthdayThisWeek ? '· 🎉 ¡Cumpleaños esta semana!' : ''}</p>}
        ...
        <div className="profile-stats">
          ...
          {semaforo && (
            <div className="pstat-card" style={{ borderColor: semaforo.color }}>
              ...
              <span className="pstat-value" style={{ color: semaforo.color, fontSize: '0.95rem' }}>{semaforo.label}</span>
